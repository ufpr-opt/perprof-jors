...
\begin{abstract}
    ...
    that makes Performance Profile using data provided by user in a friendly
    manner. This software produces graphics in PDF using \LaTeX with
...
\subsection*{Motivation}
    ...
    To make easy the reproduction of  a data set analysis, such as the
