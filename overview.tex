...
\subsection*{Motivation}
    ...
    The same group that created the Performance Profile let available a MATLAB
    script in their website~\cite{url:cops}. There is also a module inside
    NLPy~\cite{url:NLPy} able to produce the Performance Profile. However, none
    of them have the features that we wanted.

    We wanted to create a straightforward tool that would allow one to create
